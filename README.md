...
> 
> ![Подключение к серверу](screenshots/picture_g1.png) *(Положите скриншот подключения в папку screenshots)*
...
> 
> ![Выполнение скрипта 1](screenshots/picture_g2.png) ![Выполнение скрипта 2](screenshots/picture_g3.png) *(Положите скриншоты процесса и успешного завершения выполнения скрипта)*
...
1. Запустите файл `setup.exe` из папки инсталлятора. На экране откроется мастер установки.

> **Рисунок Г.4 – Установка приложения (Шаг 1)**
> 
> ![Мастер установки](screenshots/picture_g4.png) *(Положите скриншот начального окна инсталлятора)*
...
> 
> ![Выбор папки для установки](screenshots/picture_g5.png) *(Положите скриншот окна выбора пути установки)*
...
> 
> ![Установка успешно завершена](screenshots/picture_g6.png) *(Положите скриншот финального окна установщика)*
...
> 
> ![Окно авторизации приложения](screenshots/picture_g7.png) *(Положите скриншот главного окна или окна входа приложения)*
